...
latitude value (lat) and a longitude value (lng) (these are GPS coordinates, examples are below).
...
console to see all the attributes that you recieved about the provided location. 
...
5. This API allows you to make only 3 requests per 
